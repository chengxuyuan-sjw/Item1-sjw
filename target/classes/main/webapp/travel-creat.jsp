    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span>申请
            </div>
        ...
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    <form class="am-form am-form-horizontal" action="/CreatTravel.action">

                        <div class="am-form-group">
                            <label for="title"  class="am-u-sm-3 am-form-label">申请事由 / ID</label>
                            <div class="am-u-sm-9">
                                <input type="text" name="seid" id="seid" value="${sessionScope.eid}" hidden>
                                <input type="text" id="title" name="title" placeholder="申请事由 / Why">
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea class="" rows="5" name="note" id="note" ></textarea>
                                <small>250字以内写出主要详情...</small>
                            </div>
                        </div>
                        <div class="am-form-group">
                            <div class="am-u-sm-9 am-u-sm-push-3">
                                <button type="submit" class="am-btn am-btn-primary">保存申请</button>
                            </div>
                        </div>
                    </form>
                </div>
